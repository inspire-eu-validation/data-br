...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/br/4.0/Bio-geographicalRegions.xsd, using strict XML schema validation.
