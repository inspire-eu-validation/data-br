...
The Data Specification on Bio-geographical Regions – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Bio-geographical Regions.
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Bio-geographical Regions - Core", are not needed as no feature instance can be of a type from that application schema.
